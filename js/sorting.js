...
export {filterProductBy, sortBy, findMinMax, printArrayResult, getFlatInventory};
 
/**
 * @description - Prints a flat array
 * @param {Array} functionResult - 
 */
function printArrayResult(functionResult){
    for (let it of functionResult){
        console.group();
        for (let i in it){
            console.log(i+": "+it[i]) 
        };
